...
const SocialMedia = () => {
  return (
    <section id="social-media" className="relative bg-[#050505] py-24 border-t border-white/5 overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#0057ff]/20 rounded-full blur-[150px] z-0 pointer-events-none" />
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-20">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <div className="max-w-3xl">
            ...
            >
              Social Media <br />
              <span className="text-[#0057ff]">Management</span>
            </motion.h2>
            <motion.p 
              initial={{ opacity: 0, x: -20 }}
              whileInView={{ opacity: 1, x: 0 }}
        ...
        <div className="bg-[#0a0a0c] border border-white/10 rounded-3xl p-8 md:p-16 relative overflow-hidden shadow-2xl">
          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-[80%] h-1/2 bg-[#0057ff]/10 blur-[100px] z-0" />
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10">
            ...
            <motion.div 
              ...
              className="hidden lg:flex w-20 h-20 bg-[#0057ff] rounded-full flex-col justify-center items-center shadow-[0_0_30px_rgba(0,87,255,0.4)] z-20 flex-shrink-0"
            >
            ...
            <motion.div 
              ...
              className="w-full lg:w-[40%] bg-black border border-[#0057ff]/50 rounded-2xl p-8 md:p-10 shadow-[0_0_40px_rgba(0,87,255,0.15)] relative overflow-hidden"
            >
              <div className="absolute top-0 left-0 w-2 h-full bg-[#0057ff]" />
              <h4 className="text-4xl font-bebas text-white mb-8 tracking-wider">After (Month 6)</h4>
              
              <div className="space-y-6 relative z-10">
                <div className="flex items-center gap-3 md:gap-4">
                  <div className="p-2 md:p-3 bg-[#0057ff]/20 rounded-lg text-[#0057ff] flex-shrink-0"><Users size={22} /></div>
                  <div className="min-w-0">
                    <p className="text-white/50 text-xs font-sans uppercase tracking-widest font-bold">Followers</p>
                    <p className="text-2xl md:text-4xl font-black font-sans text-white leading-tight">124,500 <span className="text-[#0057ff] text-xs md:text-sm tracking-normal">↑ +10,200%</span></p>
                  </div>
                </div>

                <div className="flex items-center gap-4">
                  <div className="p-3 bg-[#0057ff]/20 rounded-lg text-[#0057ff]"><TrendingUp size={24} /></div>
                  <div>
                    <p className="text-white/50 text-xs font-sans uppercase tracking-widest font-bold">Monthly Reach</p>
                    <p className="text-4xl font-black font-sans text-white">3.2M <span className="text-[#0057ff] text-sm tracking-normal">↑ +20,600%</span></p>
                  </div>
                </div>
              </div>
