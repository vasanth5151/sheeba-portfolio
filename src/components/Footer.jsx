...
const Footer = () => {
  return (
    <footer className="relative bg-[#020202] py-32 overflow-hidden flex flex-col items-center border-t border-white/5">
      ...
      {/* Social Links */}
      <div className="relative z-10 flex flex-wrap gap-8 md:gap-14 item-center text-white/60 text-sm font-sans tracking-wide">
        ...
        <a href="mailto:fooyzeffects128@gmail.com" className="flex items-center gap-3 hover:text-white transition-colors duration-300 group">
          ...
          <span>sheebavenkatesan27@gmail.com</span>
        </a>

        <a href="https://www.instagram.com/sheeba_venkatesan_27/" target="_blank" rel="noreferrer" className="flex items-center gap-3 hover:text-white transition-colors duration-300 group">
          <span className="group-hover:text-[#e1306c] transition-colors"><InstagramIcon /></span>
          <span>sheeba_venkatesan_27</span>
        </a>
